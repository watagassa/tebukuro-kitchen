  ...
  return (
    <>
      <div className="fixed inset-x-0 bottom-0 top-0 -z-50 bg-white">
        ...
        {/* フッター */}
        <div className="fixed bottom-0 z-20 flex h-16 w-full justify-center bg-orange-400 text-white">
          <div className="fixed bottom-0 z-30 flex h-16 w-full justify-between pb-3 text-white">
            {page == 0 ? (
              ...
              <button
                ...
                className="h-16 w-20 bg-transparent pb-3 font-bold"
              >
