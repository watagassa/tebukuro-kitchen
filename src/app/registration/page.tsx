          ...
          <main className="pr-4 pl-4">
            ...
            <section className="bg-gray-100 h-56 w-9/12 mx-auto rounded-xl mt-10 mb-12 shadow-lg flex-col flex gap-y-4 justify-center items-center relative">
              ...
              <div className="absolute right-[-16px] bottom-[-16px]">
                ...
                >
                  <BiCamera className="text-2xl text-orange-400" />
                </button>
                <input
              ...
              <section className="items-center  border-gray-400 bg-[#FEF9EC]">
                <section className="flex">
                  ...
                  <input
                    ...
                    autoCapitalize="off"
                    autoCorrect="off"
                    className="w-full bg-[#FEF9EC] pl-3 h-10 outline-none"
                  />
                </section>
                <div className="text-red-500">
            ...
            <section className="items-center border-b border-gray-400 bg-[#FEF9EC] mt-3 w-52">
              <section className="flex">
                <WiTime4 className="ml-3 text-gray-400 text-5xl" />
                <input
                  ...
                  autoCapitalize="off"
                  autoCorrect="off"
                  className="pt-1 bg-[#FEF9EC] pl-2 h-10 outline-none"
                />
              </section>
              {/* zodのエラー文 */}
            ...
            <section>
              <div className="relative inline-block">
                <Image
                  ...
                  width={80}
                />
                <p className="absolute inset-0 flex items-center justify-center font-semibold translate-y-4 text-gray-600 left-[-16px]">
                  材料
                </p>
              </div>
              ...
              <div className="items-center border-b border-gray-400 bg-[#FEF9EC] mt-3">
                <input
                  ...
                  autoCapitalize="off"
                  autoCorrect="off"
                  className="w-full pl-3 bg-[#FEF9EC] h-10 outline-none"
                />
                {/* zodのエラー文 */}
                <div className="text-red-500">
